(function(){
  function exo(){
    ...
    var under=exo.zone, bottom=exo.bottomZone||exo.zone;
    function lib(cb){
      if(window.__EXO_LOADED__) return cb();
      var s=document.createElement('script');
      s.src='https://a.exdynsrv.com/ad-provider.js'; s.async=true;
    ...
    lib(function(){ mount('ad-left',left); mount('ad-right',right); mount('ad-under-hero',under); mount('ad-bottom',bottom); });
  }
  function ero(){
  ...
  function pop(){
    ...
    if(window.__POPADS_LOADED__) return; window.__POPADS_LOADED__=true;
