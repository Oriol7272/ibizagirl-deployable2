(function(){
  ...
  function startRotation(list){
    ...
    if(!list||!list.length){
      el.style.backgroundImage='url("decorative-images/paradise-beach.png")';
      el.style.opacity=.28; return;
    }
    var i=0; function rot(){ el.style.opacity=0; var src=list[i%list.length];
      setTimeout(function(){ el.style.backgroundImage='url("'+src+'")'; el.style.opacity=.28; },220); i++; }
