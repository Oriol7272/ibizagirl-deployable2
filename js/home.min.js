(function(){
  ...
  document.addEventListener('DOMContentLoaded',function(){
    ...
    // Garantiza CONTENT_PUBLIC aunque el módulo no lo exporte
    if ((!Array.isArray(window.CONTENT_PUBLIC) || window.CONTENT_PUBLIC.length===0) && U.autodetectPublic){
      U.autodetectPublic();
    }

    var pub=window.CONTENT_PUBLIC||[];
    if(!Array.isArray(pub) || pub.length===0){
      console.warn("⚠️ CONTENT_PUBLIC sigue vacío; no puedo construir carrusel/galería");
      return;
    }
