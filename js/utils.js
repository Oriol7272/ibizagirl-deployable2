...
export function shuffleSeeded(arr, seed){ const a=[...arr]; let m=a.length,i,t; const rand=()=>{ seed=(seed*9301+49297)%233280; return seed/233280; }; while(m){ i=Math.floor(rand()*m--); t=a[m]; a[m]=a[i]; a[i]=t; } return a; }
