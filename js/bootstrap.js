(function(W){
  ...
  function tryStart(){
    ...
    if (document.getElementById('home-gallery') && W.IBG_GALLERY && W.IBG_POOLS){ log('🖼️ Home gallery: full=', (W.IBG_POOLS.full||[]).length); W.IBG_GALLERY.renderPublic('home-gallery', 40); }
    if (document.getElementById('premium-gallery') && W.IBG_GALLERY && W.IBG_POOLS){ log('💎 Premium: uncensored=', (W.IBG_POOLS.uncensored||[]).length); W.IBG_GALLERY.renderPremium('premium-gallery', 100, 0.30, (W.__ENV&&__ENV.PRICE_IMAGE_EUR)||"0.10€"); W.IBG_GALLERY.wirePaywall('paywall-modal'); }
    if (document.getElementById('videos-grid') && W.IBG_GALLERY && W.IBG_POOLS){ log('🎬 Videos: count=', (W.IBG_POOLS.videos||[]).length); W.IBG_GALLERY.renderVideos('videos-grid', 20, (W.__ENV&&__ENV.PRICE_VIDEO_EUR)||"0.30€"); W.IBG_GALLERY.wirePaywall('paywall-modal'); }
