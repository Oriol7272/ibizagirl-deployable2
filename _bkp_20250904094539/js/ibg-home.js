(function(){
  ...
  function startRotation(list){
    ...
    var i=0; function rot(){ bannerImg.style.opacity=0; var src=list[i%list.length];
      setTimeout(function(){ bannerImg.style.backgroundImage='url("'+src+'")'; bannerImg.style.opacity=.28; },220); i++; }
  ...
  document.addEventListener('DOMContentLoaded',function(){
    ...
    var used=new Set(c30); var rest=pub.filter(function(x){return !used.has(U.norm(x,'full'))});
