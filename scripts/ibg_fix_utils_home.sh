...
# ✅ Sustituye utils-home.js por versión robusta (hash32 + mulberry32)
mkdir -p js
...
git add js/utils-home.js
git commit -m "fix(home): utils-home PRNG (mulberry32 + hash32) to avoid invalid assignment"
