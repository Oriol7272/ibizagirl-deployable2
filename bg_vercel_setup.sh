...
PROJECT="${PROJECT:-beachgirl-final}"        # Nombre del proyecto en Vercel
TEAM="${TEAM:-oriols-projects-ed6b9b04}"     # Scope / equipo en Vercel
DOMAIN="${DOMAIN:-beachgirl.pics}"           # Dominio final
...
# ==== Linking proyecto (en el repo local beachgirl-deployable2) ====
...
echo "== HEAD beachgirl.pics =="
curl -sSIL "https://$DOMAIN/" | sed -n '1,5p' || true
echo "== HEAD www.beachgirl.pics =="
